...
public class HitGAWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(HitGAWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/HitGAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/HitGAIW/InitOutcome.xml").getDocumentElement();
